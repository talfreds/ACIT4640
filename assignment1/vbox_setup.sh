...
create_network () {
	vbmg natnetwork add --netname "$NET_NAME" --network "192.168.230.0/24" --enable --dhcp off --port-forward-4 "ssh:tcp:[0.0.0.0]:"$SSH_PORT":[192.168.230.10]:22" --port-forward-4 "http:tcp:[0.0.0.0]:""$WEB_PORT"":[192.168.230.10]:80"
}
